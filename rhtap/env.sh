...
export IMAGE_URL=${IMAGE_URL-quay.io/lucarval-rhtap/testing-go-on-gh-ci:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/lucarval-rhtap/testing-go-on-gh-ci-gitops
